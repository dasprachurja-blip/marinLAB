            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/8 flex items-center justify-center text-text-tertiary hover:text-accent hover:border-accent/30 transition-all duration-300"
