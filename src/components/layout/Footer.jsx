...
function GlowWordmark() {
  ...
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-20">
      ...
      >
        {/* ARCT IQ — white */}
        <span className="glow-wordmark-white">ARCT</span>
        <span className="glow-wordmark-white">IQ</span>
        {/* FLOW — blue */}
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#050506] overflow-hidden">
      {/* Noise overlay */}
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-16">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="ArctiqFlow Logo" className="w-10 h-10 object-contain" />
              <span className="text-lg font-bold uppercase tracking-tight text-white">ArctiqFlow</span>
            </div>
            <p className="text-sm text-white/40 leading-relaxed max-w-xs">
              Design &amp; development studio crafting premium digital experiences for ambitious brands.
            </p>
            <p className="text-xs text-white/25">Based in Dhaka, Bangladesh</p>
          </div>

          {/* Column 2 — Navigation */}
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.25em] text-white/25 mb-5">Navigation</p>
          ...
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.25em] text-white/25 mb-5">Connect</p>
            <a
              href="mailto:dasprachurja@gmail.com"
              className="text-sm text-white/50 hover:text-white transition-colors duration-300 block mb-6"
            >
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/8 flex items-center justify-center text-white/30 hover:text-white hover:border-white/20 transition-all duration-300"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pb-8">
          <p className="text-xs text-white/20">
            © {new Date().getFullYear()} ArctiqFlow. Engineered for the digital era.
          </p>
