...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <header className="relative min-h-[50vh] flex items-end pb-16 md:pb-24 pt-32 overflow-hidden bg-void">
              ...
              <div className="glass-card p-8 md:p-12">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea name="message" value={form.message} onChange={handleChange} required rows={5} placeholder="Tell us about your project, goals, and timeline..." className={`${inputClasses} resize-none`} />
                  </div>
